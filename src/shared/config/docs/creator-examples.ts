export const CREATOR_EXAMPLES = {
	profile: {
		...
		engineeringPrinciples: [
			{
				...
				description:
					"Strict adherence to FSD for modular and maintainable system structure."
			},
			{
				title: "Performance Optimization",
				description:
					"Delivering high-performance interfaces and robust backend APIs with zero bloat."
			},
			{
				title: "Engineering Precision",
				description:
					"Combining pixel-perfect UI with robust, type-safe architectural patterns."
			},
			{
				title: "Contractual Determinism",
				description:
					"Every rule is a conscious engineering choice designed to eliminate ambiguity."
			}
		],
		techStack: {
		...
		philosophy:
			"Engineering precision combined with product thinking: building systems that are technically robust while delivering high-performance user experiences.",
		connections: {
