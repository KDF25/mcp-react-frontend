							...
							<Card className="border-primary/10 hover:border-primary/30 transition-all group">
								...
								<CardContent className="pt-4 space-y-4">
									<p className="text-sm text-muted-foreground leading-relaxed">
										Primary analysis engine. Validates file
										paths against FSD layer rules and naming
										conventions. Returns a detailed JSON
										object of violations and
										recommendations.
									</p>
									<div className="space-y-2">
										...
										<CodeBlock
											...
											language="json"
											code={
												REFERENCE_EXAMPLES.inputSchema
											}
										/>
									</div>
								</CardContent>
							...
							<Card className="border-primary/10 group">
								...
								<CardContent className="pt-2">
									<p className="text-sm text-muted-foreground italic">
										Fetches all dynamic rules from
										`RulesProvider`. Always use this to
										synchronize current LLM context with
										server state.
									</p>
								</CardContent>
							</Card>
					...
					<section className="space-y-6">
						...
						<Card className="bg-muted/30 border-dashed">
							<CardHeader>
								...
								<CardDescription>
									Step-by-step connection for model
									orchestration
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6">
								...
								<div className="space-y-3">
									...
									<p className="text-[10px] text-muted-foreground italic">
										Note: Restart Claude Desktop after
