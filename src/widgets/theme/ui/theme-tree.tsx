...
import { THEME_TREE_ITEMS } from "../model";

function ThemeTreeComponent() {
	const { t } = useTranslation("theme");

	const themeTree = useTree<ITreeItemData>({
		dataLoader: {
			getChildren: (itemId) => THEME_TREE_ITEMS[itemId]?.children ?? [],
			getItem: (itemId) => THEME_TREE_ITEMS[itemId]
		},
...
export const ThemeTree = withErrorBoundary(ThemeTreeComponent);
