...
import { ZOD_TREE_ITEMS } from "../model";

function ZodTreeComponent() {
	const t = useTranslations("zod");

	const entityTree = useTree<ITreeItemData>({
		dataLoader: {
			getChildren: (itemId) => ZOD_TREE_ITEMS[itemId]?.children ?? [],
			getItem: (itemId) => ZOD_TREE_ITEMS[itemId]
		},
...
export const ZodTree = withErrorBoundary(ZodTreeComponent);
